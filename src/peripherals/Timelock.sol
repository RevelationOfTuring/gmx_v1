...
import "src/peripherals/interfaces/ITimelock.sol";
import "src/peripherals/interfaces/ITimelockTarget.sol";
import "src/peripherals/interfaces/IHandlerTarget.sol";
import "src/access/interfaces/IAdmin.sol";
import "src/core/interfaces/IVault.sol";
import "src/peripherals/interfaces/IVaultExtended.sol";
...
import "src/tokens/interfaces/IYieldToken.sol";
import "src/tokens/interfaces/IBaseToken.sol";
import "src/tokens/interfaces/IMintable.sol";
import "src/tokens/interfaces/IUSDG.sol";
import "src/staking/interfaces/IVester.sol";
import "src/staking/interfaces/IRewardRouterV2.sol";
import "src/libraries/token/IERC20.sol";

// https://arbiscan.io/address/0xe7E740Fa40CA16b15B621B49de8E9F0D69CF4858
contract Timelock is ITimelock {
    ...
    function setMaxGlobalShortSize(address _vault, address _token, uint256 _amount) external onlyAdmin {
        IVaultExtended(_vault).setMaxGlobalShortSize(_token, _amount);
    }
    ...
    function setVaultUtils(address _vault, IVaultUtils _vaultUtils) external onlyAdmin {
        IVaultExtended(_vault).setVaultUtils(_vaultUtils);
    }
